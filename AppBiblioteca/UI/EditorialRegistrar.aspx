<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditorialRegistrar.aspx.cs" Inherits="UI.EditorialRegistrar" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

     <div style="text-align: center; background-color: mediumorchid; padding: 10px 0px">   
        <h3>¡Editoriales - Registrar</h3>
    </div>
