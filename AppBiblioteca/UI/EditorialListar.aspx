...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div align="center">   
        <asp:GridView ID="gvEditoriales" AutoGenerateColumns="false" runat="server" ForeColor="Black" BackColor="LightGoldenrodYellow" BorderColor="Tan" BorderWidth="1px" CellPadding="2" GridLines="None" AllowPaging="True" OnPageIndexChanging="gvEditoriales_PageIndexChanging" PageSize="5">
